...
export default function useComment(){
    ...
    async function createComment(data: IComment<"CREATE"> | IComment<"RESPONSE">): Promise<ResponseMessage>{
        try {
    ...
    async function updateComment({description,comment_id}: IComment<"UPDATE">): Promise<ResponseMessage>{
        try {
