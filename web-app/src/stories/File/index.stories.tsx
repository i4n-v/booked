...
const  meta: Meta<InputFileProps> = {
    ...
    parameters: {
        docs: {
            page: () => (
                <>
                <Title />
                <Description>File input component allows users to attach one or multiple files.</Description>
    ...
    argTypes: {
        ...
        accept: {
            description: "The accept attribute specifies a filter for what file types the user can pick from the file input dialog box."
        },
        label: {
