...
export default function Home() {
    ...
    return <>
        <>
            <Menu></Menu>
            <Grid container sx={{ backgroundColor: 'secondary.light' }}>
                <Grid item xs={12}>
                    <Box height="100vh" position="relative" display="flex" justifyContent="left" alignItems="center" overflow="hidden">
                        ...
                        <Typography variant="h1"
                            ...
                            Conheça um <span style={{ color: "#9b51e0" }}>mundo<br />novo</span> em cada livro!
                        </Typography>
                ...
                <Grid item xs={12} sx={{
                    height: "95vh", display: 'flex', flexDirection: 'column', pl: 8, py: 10
                }}>
                ...
                <Grid item xs={12} position="relative" sx={{ height: "85vh" }}>
                    <Box sx={{ height: "80%", width: '100%', display: 'flex', alignItems: 'center', backgroundColor: (t) => t.palette.secondary.main }} >
                        <Box sx={{ padding: 8 }}>
                            <Typography variant="h2" sx={{
                                color: (t) => t.palette.secondary[50],
                                font: (t) => t.font.xl,
                                ...
                                Ainda não conhece a nossa <span style={{ color: "#9b51e0" }}><br></br>Comunidade?</span>
                            </Typography>
                            ...
                            <Button variant="outlined" sx={{ font: (t) => t.font.xs, mt: 4 }}>
                                Cadastre-se já
                            </Button>
                        </Box>
                ...
                <Grid item xs={12} sx={{ display: 'flex', height: "85vh", justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Box sx={{ width: '50%' }}>
                        <Typography variant="h2" sx={{
                            ...
                            Você possui alguma <span style={{ color: "#9b51e0" }}><br></br>dúvida?</span>
                        </Typography>
                        <Typography variant="h5" pb={8} sx={{
                            font: (t) => t.font.md,
